        ...
        public class UMARecipe {
            ...
            public void UpdateMeshHideMasks() {
                for (int i = 0; i < slotDataList.Length; i++) {
                    ...
                    if (MeshHideDictionary.ContainsKey(sd.slotName)) {   //If this slotDataAsset is found in the MeshHideDictionary then we need to supply the SlotData with the bitArray.
